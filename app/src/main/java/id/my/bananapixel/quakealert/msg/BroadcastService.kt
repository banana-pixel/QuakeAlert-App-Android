...
class BroadcastService(private val ctx: Context) {
    ...
    companion object {
        ...
        private const val MESSAGE_RECEIVED_ACTION = "id.my.bananapixel.quakealert.MESSAGE_RECEIVED"
        private const val MESSAGE_SEND_ACTION = "id.my.bananapixel.quakealert.SEND_MESSAGE"
        private const val USER_ACTION_ACTION = "id.my.bananapixel.quakealert.USER_ACTION"
    }
}
