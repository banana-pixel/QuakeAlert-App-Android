...
class SubscriberService : Service(), KoinComponent {
    ...
    private fun onNotificationReceived(subscription: Subscription, notification: id.my.bananapixel.quakealert.db.Notification) {
    ...
    class ConnectionAlertBroadcastReceiver : BroadcastReceiver(), KoinComponent {
    ...
    companion object {
        ...
        private const val NOTIFICATION_GROUP_ID = "id.my.bananapixel.quakealert.NOTIFICATION_GROUP_SERVICE"
        ...
        private const val CONNECTION_ALERT_ACTION_DISMISS = "id.my.bananapixel.quakealert.CONNECTION_ALERT_DISMISS"
        private const val CONNECTION_ALERT_ACTION_SNOOZE = "id.my.bananapixel.quakealert.CONNECTION_ALERT_SNOOZE"
        private const val CONNECTION_ALERT_ACTION_NEVER = "id.my.bananapixel.quakealert.CONNECTION_ALERT_NEVER"
    }
}
