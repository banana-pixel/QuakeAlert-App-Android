...
import id.my.bananapixel.quakealert.util.AfterChangedTextWatcher
import id.my.bananapixel.quakealert.util.formatBytes
import id.my.bananapixel.quakealert.util.mimeTypeToIconResource
